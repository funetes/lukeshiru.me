	...
	>
		<svg class="overflow-visible" viewBox="0 0 80 80">
			<path
				...
				// eslint-disable-next-line max-len
				class="animation animation-ease-in-out animation-fill-both animation-shrink-rotate origin-center transform opacity-0"
				fill="#000"
				stroke-width="2"
				stroke="#fff"
			...
			<path
				...
				fill="#fff"
				// eslint-disable-next-line max-len
				class="animation animation-ease-out animation-fill-both animation-fade-in origin-center transform opacity-0"
				// eslint-disable-next-line max-len
